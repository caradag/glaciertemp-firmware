...
python3 extract.py "$SRC" \
  'GlacierTemp_1_cell_v02_claude.ino:#FIRMWARE_VERSION,#PROTOCOL_VERSION,#SECTOR_SIZE,#MAX_SECTORS' \
  'Functions.ino:hexDigit' \
  'EEPROM.ino:#LOGB_BLOCK,#LOGB_CHUNK,#FLOW_XOFF,#FLOW_XON,printHex16,crc16Ccitt,writeU16LE,flowControlCheck,dumpLogBinary,printMetadata,printVersion' \
  > extracted.h
